...
public interface PascalVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link PascalParser#listStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitListStatement(PascalParser.ListStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link PascalParser#pwdStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPwdStatement(PascalParser.PwdStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link PascalParser#createFileStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCreateFileStatement(PascalParser.CreateFileStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link PascalParser#createDirStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCreateDirStatement(PascalParser.CreateDirStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link PascalParser#removeFileStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRemoveFileStatement(PascalParser.RemoveFileStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link PascalParser#removeDirStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRemoveDirStatement(PascalParser.RemoveDirStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link PascalParser#execStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	 ...
	 * @return the visitor result
	 */
	T visitOpenStatement(PascalParser.OpenStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link PascalParser#moveStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMoveStatement(PascalParser.MoveStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link PascalParser#copyStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCopyStatement(PascalParser.CopyStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link PascalParser#printFileStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
