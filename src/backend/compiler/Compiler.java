...
public class Compiler extends PascalBaseVisitor<Object> {
    ...
    @Override
    public Object visitListStatement(PascalParser.ListStatementContext ctx) {
        statementCode.emitList(ctx);
        return null;
    }

    @Override
    public Object visitPwdStatement(PascalParser.PwdStatementContext ctx)
    {
        statementCode.emitPwd(ctx);
        return null;
    }

    @Override
    public Object visitCreateFileStatement(PascalParser.CreateFileStatementContext ctx)
    {
        statementCode.emitCreateFile(ctx);
        return null;
    }

    @Override
    public Object visitCreateDirStatement(PascalParser.CreateDirStatementContext ctx) {
        statementCode.emitCreateDir(ctx);
        return null;
    }

    @Override
    public Object visitRemoveFileStatement(PascalParser.RemoveFileStatementContext ctx) {
        statementCode.emitRemoveFile(ctx);
        return null;
    }

    @Override
    public Object visitRemoveDirStatement(PascalParser.RemoveDirStatementContext ctx) {
        statementCode.emitRemoveDir(ctx);
        return null;
    }

    @Override
    public Object visitExecStatement(PascalParser.ExecStatementContext ctx) {
        statementCode.emitExec(ctx);
        return null;
    }
    ...
    @Override
    public Object visitOpenStatement(PascalParser.OpenStatementContext ctx) {
        statementCode.emitOpen(ctx);
        return null;
    }

    @Override
    public Object visitMoveStatement(PascalParser.MoveStatementContext ctx) {
        statementCode.emitMove(ctx);
        return null;
    }

    @Override
    public Object visitCopyStatement(PascalParser.CopyStatementContext ctx) {
        statementCode.emitCopy(ctx);
        return null;
    }

    @Override
    public Object visitPrintFileStatement(PascalParser.PrintFileStatementContext ctx) {
